...
// import Logo from "../../../assets/logo.svg"; // keep your logo path
...
//                 {["All Startups", "Fintech", "EdTech"].map(
//                   (item) => (
//                     <li key={item}>
//                       <Link
//                         href={
...
//               <ul className="mt-4 space-y-3">
//                 <li>
//                   <Link href="/" className="text-[#d1d1d1] hover:text-white text-sm transition-colors">
//                     Home
//                   </Link>
//                 </li>
//                 <li>
...
//         {/* Bottom Bar */}
//         <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[#252525] pt-8 sm:flex-row">
//           <p className="text-xs text-[#888]">
//             © 2025 . Built by{" "}
//             <span className="text-red-500 text-2xl font-medium">Kavya Kapoor</span>
//           </p>
